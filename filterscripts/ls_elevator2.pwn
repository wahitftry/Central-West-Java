...
#define DOORS_SPEED         (1.0)   // Movement speed of the doors.
#define ELEVATOR_WAIT_TIME  (1000)  // Time in ms that the elevator will wait in each floor before continuing with the queue.
...
stock ShowElevatorDialog(playerid)
{
	...
	ShowPlayerDialog(playerid, DIALOG_ID, DIALOG_STYLE_LIST, "Elevator", string, "Select", "Cancel");
